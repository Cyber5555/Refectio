  ...
  constructor(props) {
    ...
    this.state = {
      ...
      view1: [
        ...
        { companyLogo: require('../../assets/image/category9.png'), category_name: 'Гостиные', filterName: 'Гостиные', size: 10, lineHeight: 12.9, id: 7 },
        { companyLogo: require('../../assets/image/category6.png'), category_name: 'Детские', filterName: 'Детские', size: 10, lineHeight: 12.9, id: 8 },
        { companyLogo: require('../../assets/image/category8.png'), category_name: 'Кабинеты', filterName: 'Кабинеты', size: 10, lineHeight: 12.9, id: 9 },
