    ...
    await fetch(`${APP_URL}AuthUserProfile`, {
      ...
      .then(res => {
        this.setState({
          ...
          site: res.data[0].saite !== 'null' && res.data[0].saite !== null ? 'https://' + res.data[0].saite : '',
          teleg: res.data[0].telegram !== null ? 't.me/' + res.data[0].telegram : 't.me/',
        })
      })
  }
                      ...
                      <View style={{ position: 'relative' }}>
                        <TextInput
                          ...
                          onChangeText={(text) => {
                            ...
                            if (text == 'https://' || text == 'https:/' || text == 'https:' || text == 'https' || text == 'http' || text == 'htt' || text == 'ht' || text == 'h') {
                              text = 'https://';
                      ...
                      <View>
                        ...
                        <View style={{
                          ...
                          }
                          {
                            ...
                            <TouchableOpacity onPress={() => { Linking.openURL('https://' + item.saite) }}>
                              <Image
